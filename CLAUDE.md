...
3. `SEO-AUDIT.md` — план продвижения: «Аудит 3» (2026-09-24, вечер) — перепроверка после правок и новые замечания, «Аудит 2» (2026-09-24) — основной план (ссылки, контент), «Аудит 1» — выполнен.
...
- Повторяющиеся задачи, которые запускаются автоматически (расписания и Routines, cron, `/loop`, самонапоминания и периодические проверки PR по таймеру, workflow GitHub Actions с `schedule`), создавать и запускать только с отдельного явного согласия заказчика — на каждую такую задачу. Согласие на саму работу («сделай», «опубликуй», «открой PR») согласием на расписание не считается. Предложить такую задачу можно, включить — только после ответа «да».
